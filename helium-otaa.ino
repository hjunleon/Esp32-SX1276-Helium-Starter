...
void do_send(osjob_t* j) {
  ...
  if (LMIC.opmode & OP_TXRXPEND) {
    ...
    LMIC_setTxData2(1, mydata, sizeof(mydata) - 1, 0); // Perhaps send a struct. Multi rate system may be complicated, so just send less frequently, at most inference for certain data can do more often?
...
void setup() {
  ...
  //    LMIC_setClockError(1 * MAX_CLOCK_ERROR / 40);  LMIC_setClockError(MAX_CLOCK_ERROR * 3 / 100);
